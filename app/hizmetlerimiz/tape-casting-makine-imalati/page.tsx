...
import { ArrowRight, Mail, DollarSign, Layers, Thermometer, Cpu, Ruler, Repeat, ChevronDown } from "lucide-react";
    ...
    <div>
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description:
              "Batarya teknolojileri, ince film ve fonksiyonel seramik üretimi için mikron hassasiyetli, PLC otomasyonlu endüstriyel şerit döküm (tape casting) ve slip-casting makine imalatı.",
            areaServed: {
              "@type": "Country",
              name: "Turkey",
            },
            hasOfferCatalog: {
              "@type": "OfferCatalog",
              name: "Şerit Döküm ve Döküm Çözümleri",
              itemListElement: [
                {
                  "@type": "Offer",
                  itemOffered: {
                    "@type": "Service",
                    name: "Endüstriyel Ölçekli Tape Casting Hatları (20 Metreye Varan)",
                  },
                },
                {
                  "@type": "Offer",
                  itemOffered: {
                    "@type": "Service",
                    name: "Laboratuvar Tipi Ar-Ge Tape Casting Cihazları",
                  },
                },
                {
                  "@type": "Offer",
                  itemOffered: {
                    "@type": "Service",
                    name: "Kurutma Kamaraları ve Termal Kontrol Sistemleri",
                  },
                },
              ],
            },
      ...
      <section className="w-full bg-slate-900 bg-gradient-to-b from-slate-900 via-slate-800/95 to-slate-900 flex flex-col items-center justify-center text-center h-[380px] px-4">
        <h1 className="text-4xl md:text-5xl font-bold text-white">
          İleri Teknoloji ve Yüksek Hassasiyetli Tape Casting Makine İmalatı
        </h1>
        <p className="mt-5 max-w-2xl text-gray-300 text-sm md:text-base leading-relaxed">
          İnnovia Plus ile mikron hassasiyetli tape casting (şerit döküm) makine
          imalatı! Seramik ve batarya üretimine özel 20 metrelik hatlar için
          hemen teklif alın.
        </p>
        <a
          href="#teklif-al"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="lg:order-2">
              <div className="rounded-2xl md:rounded-3xl overflow-hidden shadow-md">
                <img
                  src="/images/innoviaplus-tape-casting-makine-imalati.webp"
                  alt="İnnovia Plus Tape Casting Makine İmalatı ve Şerit Döküm Sistemleri"
            ...
            <div className="lg:order-1">
              ...
              <p className="mt-5 text-sm md:text-base text-gray-500 leading-relaxed">
                Gelişmiş elektronik malzemeler, fonksiyonel seramikler ve batarya
                teknolojilerinin üretiminde kusursuz bir kalınlık kontrolü ve
                pürüzsüz yüzey elde etmek hayati önem taşır. Bu hassas dengeyi
                sağlamak için işletmenize ve kimyasal proseslerinize tamamen
                özel tasarlanan sistemler inşa ediyoruz.
              </p>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="mt-3 text-sm md:text-base text-gray-500 leading-relaxed">
                      Döküm kalınlık toleranslarını mikron seviyesinde hatasız
                      yönetebileceğiniz yüksek kapasiteli makinelerimiz ile
      ...
      <section className="bg-[#f0f1f9] pt-[70px] pb-0">
        <div className="max-w-6xl mx-auto px-4">
          <div className="text-center">
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-slate-900 leading-tight">
              İnnoviaPlus Tarafından Sunulan Tape Casting Hizmetlerimiz
            </h2>
            ...
            <p className="text-slate-600 max-w-3xl mx-auto mt-4 text-base md:text-lg mb-12">
              İnce film, fonksiyonel seramikler ve batarya teknolojileri
              üretimine yönelik kapsamlı tape casting çözümleri sunuyoruz.
            </p>
          </div>
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4 md:gap-6">
            <div className="bg-white border border-slate-100 rounded-xl p-4 md:p-6 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg hover:border-orange-500/30">
              ...
              <h3 className="text-sm md:text-base font-bold text-slate-900 mt-4">
                Endüstriyel Tape Casting Hatları
              </h3>
              <p className="text-xs md:text-sm text-slate-500 mt-1 leading-relaxed">
                20 metreye varan yüksek kapasiteli şerit döküm sistemleri.
              </p>
            </div>
            <div className="bg-white border border-slate-100 rounded-xl p-4 md:p-6 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg hover:border-orange-500/30">
              <div className="bg-orange-500/10 text-orange-500 rounded-lg p-2 w-10 h-10 flex items-center justify-center">
              ...
              <h3 className="text-sm md:text-base font-bold text-slate-900 mt-4">
                Laboratuvar Tipi Ar-Ge Cihazları
              </h3>
              <p className="text-xs md:text-sm text-slate-500 mt-1 leading-relaxed">
                Ar-Ge çalışmaları için hassas laboratuvar ölçekli döküm cihazları.
              </p>
            </div>
            <div className="bg-white border border-slate-100 rounded-xl p-4 md:p-6 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg hover:border-orange-500/30">
              <div className="bg-orange-500/10 text-orange-500 rounded-lg p-2 w-10 h-10 flex items-center justify-center">
              ...
              <p className="text-xs md:text-sm text-slate-500 mt-1 leading-relaxed">
                Termal kontrollü, sensör donanımlı yeni nesil kurutma sistemleri.
              </p>
            </div>
            <div className="bg-white border border-slate-100 rounded-xl p-4 md:p-6 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg hover:border-orange-500/30">
              <div className="bg-orange-500/10 text-orange-500 rounded-lg p-2 w-10 h-10 flex items-center justify-center">
              ...
              <p className="text-xs md:text-sm text-slate-500 mt-1 leading-relaxed">
                Kullanıcı dostu arayüz ile tam otomatik operasyon yönetimi.
              </p>
            </div>
            <div className="bg-white border border-slate-100 rounded-xl p-4 md:p-6 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg hover:border-orange-500/30 col-span-2 md:col-span-1">
              ...
              <h3 className="text-sm md:text-base font-bold text-slate-900 mt-4">
                Modüler Makine Mimarisi
              </h3>
              <p className="text-xs md:text-sm text-slate-500 mt-1 leading-relaxed">
                Her kapasiteye uygun ölçeklenebilir ve esnek makine tasarımı.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="bg-[#f0f1f9] pt-[70px] pb-16 md:pb-24">
        <div className="max-w-6xl mx-auto px-4">
          <div className="text-center">
            ...
            <hr className="w-16 h-0.5 bg-orange-500 border-0 mx-auto mt-4 mb-[25px]" />
            <p className="text-slate-600 max-w-3xl mx-auto mt-4 text-base md:text-lg mb-12">
              Tape casting makine imalatı süreçleri hakkında en çok merak
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            <details className="group bg-white border border-slate-100 rounded-2xl overflow-hidden shadow-sm hover:shadow-md transition-shadow duration-300">
              <summary className="flex items-center justify-between gap-4 px-6 py-5 cursor-pointer list-none text-sm md:text-base font-semibold text-slate-900 hover:bg-slate-50 transition-colors">
                Tape casting makinenizin maksimum genişliği nedir?
              ...
              <div className="px-6 pb-5 text-sm md:text-base text-gray-500 leading-relaxed border-t border-slate-100 pt-4">
                Proje gereksinimlerinize bağlı olarak 20 metreye kadar endüstriyel ölçekli hatlar üretebiliyoruz.
              </div>
            </details>
            <details className="group bg-white border border-slate-100 rounded-2xl overflow-hidden shadow-sm hover:shadow-md transition-shadow duration-300">
              <summary className="flex items-center justify-between gap-4 px-6 py-5 cursor-pointer list-none text-sm md:text-base font-semibold text-slate-900 hover:bg-slate-50 transition-colors">
                Hangi malzemeler için tape casting makinesi kullanılabilir?
                <ChevronDown size={20} className="text-orange-500 shrink-0 transition-transform duration-300 group-open:rotate-180" />
              </summary>
              <div className="px-6 pb-5 text-sm md:text-base text-gray-500 leading-relaxed border-t border-slate-100 pt-4">
                Seramik malzemeler, batarya elektrotları, fonksiyonel oksitler ve ince film uygulamaları için uygundur.
              </div>
            </details>
            <details className="group bg-white border border-slate-100 rounded-2xl overflow-hidden shadow-sm hover:shadow-md transition-shadow duration-300">
              <summary className="flex items-center justify-between gap-4 px-6 py-5 cursor-pointer list-none text-sm md:text-base font-semibold text-slate-900 hover:bg-slate-50 transition-colors">
                Teslimat ve kurulum süresi nedir?
                <ChevronDown size={20} className="text-orange-500 shrink-0 transition-transform duration-300 group-open:rotate-180" />
              </summary>
              <div className="px-6 pb-5 text-sm md:text-base text-gray-500 leading-relaxed border-t border-slate-100 pt-4">
                Makine boyutuna bağlı olarak 8-16 hafta arasında teslimat ve yerinde kurulum hizmeti sunuyoruz.
              </div>
            </details>
            <details className="group bg-white border border-slate-100 rounded-2xl overflow-hidden shadow-sm hover:shadow-md transition-shadow duration-300">
              <summary className="flex items-center justify-between gap-4 px-6 py-5 cursor-pointer list-none text-sm md:text-base font-semibold text-slate-900 hover:bg-slate-50 transition-colors">
                PLC otomasyon desteği sağlıyor musunuz?
                <ChevronDown size={20} className="text-orange-500 shrink-0 transition-transform duration-300 group-open:rotate-180" />
              </summary>
              <div className="px-6 pb-5 text-sm md:text-base text-gray-500 leading-relaxed border-t border-slate-100 pt-4">
                Evet, tüm makinelerimiz PLC otomasyon altyapısı ile donatılmakta ve kullanıcı dostu arayüz ile yönetilmektedir.
              </div>
            </details>
          </div>
        </div>
