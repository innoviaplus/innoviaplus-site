...
import { DollarSign, ArrowRight, Mail, Wrench, Cog, ShieldCheck, Gauge, Layers, ChevronDown } from "lucide-react";
    ...
    <div>
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description:
              "Endüstriyel üretim hatları ve Ar-Ge laboratuvarları için kusursuz basınç kontrollü, özel tonaj ve strok kapasiteli hidrolik ve manuel pres imalatı çözümleri.",
            areaServed: {
              "@type": "Country",
              name: "Turkey",
            },
            hasOfferCatalog: {
              "@type": "OfferCatalog",
              name: "Pres ve Şekillendirme Sistemleri",
              itemListElement: [
                {
                  "@type": "Offer",
                  itemOffered: {
                    "@type": "Service",
                    name: "Endüstriyel Hidrolik Pres İmalatı",
                  },
                },
                {
                  "@type": "Offer",
                  itemOffered: {
                    "@type": "Service",
                    name: "Laboratuvar Tipi Manuel Pres Çözümleri",
                  },
                },
                {
                  "@type": "Offer",
                  itemOffered: {
                    "@type": "Service",
                    name: "Elektroseramik ve Kompozit Şekillendirme Presleri",
                  },
                },
              ],
            },
      ...
      <section className="w-full bg-slate-900 bg-gradient-to-b from-slate-900 via-slate-800/95 to-slate-900 flex flex-col items-center justify-center text-center h-[380px] px-4">
        <h1 className="text-4xl md:text-5xl font-bold text-white">
          Yüksek Güç ve Hassasiyet: Profesyonel Hidrolik ve Manuel Pres İmalatı
        </h1>
        <p className="mt-5 max-w-2xl text-gray-300 text-sm md:text-base leading-relaxed">
          İnnovia Plus ile Ar-Ge ve endüstriyel üretime özel mikron
          hassasiyetli hidrolik ve manuel pres imalatı. Kusursuz basınç
          kontrolü için hemen teklif alın!
        </p>
        <a
          href="#teklif-al"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="lg:order-2">
              <div className="rounded-2xl md:rounded-3xl overflow-hidden shadow-md">
                <img
                  src="/images/innoviaplus-hidrolik-ve-manuel-pres-imalati.webp"
                  alt="İnnovia Plus Hidrolik ve Manuel Pres İmalatı"
            ...
            <div className="lg:order-1">
              ...
              <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-slate-900 leading-tight mt-3">
                İleri Malzeme ve Seramik Üretimine Özel Pres Sistemleri
              </h2>
              ...
              <p className="mt-5 text-sm md:text-base text-gray-500 leading-relaxed">
                Rekabetçi sanayi koşullarında, özellikle fonksiyonel seramikler,
                elektroseramik toz basımı, kompozit şekillendirme ve ağır metal
                işleme süreçlerinde doğru basınca pürüzsüz bir şekilde ulaşmak
                kritik bir adımdır. İşletmenizin veya Ar-Ge laboratuvarınızın
                kapasitesine tam uyum sağlayan preslerimiz, sektörün en çok
                tercih edilen mühendislik standartlarıyla üretilmektedir.
              </p>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-slate-900">
                      Özel Tasarım Avantajı
                    </h3>
                    <p className="mt-3 text-sm md:text-base text-gray-500 leading-relaxed">
                      Tonaj ve strok kapasitesinden kalıp ölçülerine kadar size
                      özel çelik konstrüksiyon pres çözümleri.
                    </p>
                  </div>
                </div>
              </div>
      ...
      <section className="bg-[#f0f1f9] pt-[70px] pb-0">
        <div className="max-w-6xl mx-auto px-4">
          <div className="text-center">
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-slate-900 leading-tight">
              İnnoviaPlus Tarafından Sunulan Pres Hizmetlerimiz
            </h2>
            ...
            <p className="text-slate-600 max-w-3xl mx-auto mt-4 text-base md:text-lg mb-12">
              İhtiyacınıza yönelik kapsamlı hidrolik ve manuel pres çözümleri
              sunuyoruz.
            </p>
          </div>
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4 md:gap-6">
            <div className="bg-white border border-slate-100 rounded-xl p-4 md:p-6 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg hover:border-orange-500/30">
              ...
              <h3 className="text-sm md:text-base font-bold text-slate-900 mt-4">
                Hidrolik Pres İmalatı
              </h3>
              <p className="text-xs md:text-sm text-slate-500 mt-1 leading-relaxed">
                Yüksek tonajlı endüstriyel hidrolik pres sistemleri.
              </p>
            </div>
            <div className="bg-white border border-slate-100 rounded-xl p-4 md:p-6 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg hover:border-orange-500/30">
              <div className="bg-orange-500/10 text-orange-500 rounded-lg p-2 w-10 h-10 flex items-center justify-center">
              ...
              <h3 className="text-sm md:text-base font-bold text-slate-900 mt-4">
                Manuel Pres Çözümleri
              </h3>
              <p className="text-xs md:text-sm text-slate-500 mt-1 leading-relaxed">
                Ar-Ge ve laboratuvar tipi manuel pres sistemleri.
              </p>
            </div>
            <div className="bg-white border border-slate-100 rounded-xl p-4 md:p-6 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg hover:border-orange-500/30">
              <div className="bg-orange-500/10 text-orange-500 rounded-lg p-2 w-10 h-10 flex items-center justify-center">
              ...
              <p className="text-xs md:text-sm text-slate-500 mt-1 leading-relaxed">
                Sağlam ve sızdırmaz mekanik tasarım, güvenli kullanım.
              </p>
            </div>
            <div className="bg-white border border-slate-100 rounded-xl p-4 md:p-6 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg hover:border-orange-500/30">
              <div className="bg-orange-500/10 text-orange-500 rounded-lg p-2 w-10 h-10 flex items-center justify-center">
              ...
              <p className="text-xs md:text-sm text-slate-500 mt-1 leading-relaxed">
                İleri teknoloji valflerle stabil basınç tutma.
              </p>
            </div>
            <div className="bg-white border border-slate-100 rounded-xl p-4 md:p-6 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg hover:border-orange-500/30 col-span-2 md:col-span-1">
              ...
              <p className="text-xs md:text-sm text-slate-500 mt-1 leading-relaxed">
                Tonaj ve strok kapasitesine tam uyumlu özel çözümler.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="bg-[#f0f1f9] pt-[70px] pb-16 md:pb-24">
        <div className="max-w-6xl mx-auto px-4">
          <div className="text-center">
            ...
            <hr className="w-16 h-0.5 bg-orange-500 border-0 mx-auto mt-4 mb-[25px]" />
            <p className="text-slate-600 max-w-3xl mx-auto mt-4 text-base md:text-lg mb-12">
              Hidrolik ve manuel presler hakkında en çok merak edilen sorular
              ve cevapları.
            </p>
          </div>
          <div className="max-w-3xl mx-auto space-y-4">
            <details className="group bg-white border border-slate-100 rounded-2xl overflow-hidden shadow-sm hover:shadow-md transition-shadow duration-300">
              <summary className="flex items-center justify-between gap-4 px-6 py-5 cursor-pointer list-none text-sm md:text-base font-semibold text-slate-900 hover:bg-slate-50 transition-colors">
                Hangi tonaj aralığında pres üretiyorsunuz?
              ...
              <div className="px-6 pb-5 text-sm md:text-base text-gray-500 leading-relaxed border-t border-slate-100 pt-4">
                5 tondan 500 tona kadar hidrolik ve manuel pres imalatı gerçekleştiriyoruz.
              </div>
            </details>
            <details className="group bg-white border border-slate-100 rounded-2xl overflow-hidden shadow-sm hover:shadow-md transition-shadow duration-300">
              <summary className="flex items-center justify-between gap-4 px-6 py-5 cursor-pointer list-none text-sm md:text-base font-semibold text-slate-900 hover:bg-slate-50 transition-colors">
                Presler hangi sektörlerde kullanılıyor?
                <ChevronDown size={20} className="text-orange-500 shrink-0 transition-transform duration-300 group-open:rotate-180" />
              </summary>
              <div className="px-6 pb-5 text-sm md:text-base text-gray-500 leading-relaxed border-t border-slate-100 pt-4">
                Seramik, elektroseramik, kompozit, metal işleme ve Ar-Ge laboratuvarları başta olmak üzere birçok sektörde kullanılmaktadır.
              </div>
            </details>
            <details className="group bg-white border border-slate-100 rounded-2xl overflow-hidden shadow-sm hover:shadow-md transition-shadow duration-300">
              <summary className="flex items-center justify-between gap-4 px-6 py-5 cursor-pointer list-none text-sm md:text-base font-semibold text-slate-900 hover:bg-slate-50 transition-colors">
                Mevcut kalıplarıma uygun pres tasarlayabiliyor musunuz?
                <ChevronDown size={20} className="text-orange-500 shrink-0 transition-transform duration-300 group-open:rotate-180" />
              </summary>
              <div className="px-6 pb-5 text-sm md:text-base text-gray-500 leading-relaxed border-t border-slate-100 pt-4">
                Evet, kalıp ölçülerinize ve basınç gereksinimlerinize tam uyumlu özel pres tasarımı yapıyoruz.
              </div>
            </details>
            <details className="group bg-white border border-slate-100 rounded-2xl overflow-hidden shadow-sm hover:shadow-md transition-shadow duration-300">
              <summary className="flex items-center justify-between gap-4 px-6 py-5 cursor-pointer list-none text-sm md:text-base font-semibold text-slate-900 hover:bg-slate-50 transition-colors">
                Teslimat ve kurulum süreci nasıl işliyor?
                <ChevronDown size={20} className="text-orange-500 shrink-0 transition-transform duration-300 group-open:rotate-180" />
              </summary>
              <div className="px-6 pb-5 text-sm md:text-base text-gray-500 leading-relaxed border-t border-slate-100 pt-4">
                Üretim sonrası saha kurulumu, devreye alma ve operatör eğitimi dahil anahtar teslim hizmet sunuyoruz.
              </div>
            </details>
          </div>
        </div>
