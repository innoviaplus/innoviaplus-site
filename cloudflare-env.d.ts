/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: cf8149734950a2fe9c163c10fea6a30c)
// Runtime types generated with workerd@1.20260611.1 2026-06-13 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_CloudflareEnv {
	INNOVIAPLUS_DATA: KVNamespace;
	IMAGES: ImagesBinding;
	ASSETS: Fetcher;
	NEXTJS_ENV: string;
	WORKER_SELF_REFERENCE: Fetcher /* innoviaplus-site */;
}
